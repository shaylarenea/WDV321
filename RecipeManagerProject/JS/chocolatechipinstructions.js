...
function displayInstructions(cookieType) {
    ...
    console.log(`Instructions (${cookieType}):`, instruction);
}
...
function displayIngredients(cookieType) {
    ...
    console.log(`Ingredients (${cookieType}):`, ingredients);
}
...
if (storedInstructions) {
    console.log('Instructions loaded from local storage:', storedInstructions);
}
